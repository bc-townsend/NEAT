...
public class Genotype {
    ...
    public Genotype(int inputNum, int outputNum) {
    ...
    public Genotype(Genotype network) {
        ...
        network.allNodes.forEach(node -> {
            try {
                this.allNodes.add((Node) node.clone());
    ...
    public Genotype crossover(Genotype parent) {
        Genotype baby = null;
        if(this.fitness > parent.getFitness()) {
            baby = new Genotype(this);
        } else if(this.fitness < parent.getFitness()) {
            baby = new Genotype(parent);
        } else {
            baby = new Genotype(this);
            // TODO: 9/30/20 Finish crossover function. 
        }
    ...
    public void mutate() {
        ...
        // TODO: 9/30/20 Add a toggle enabled mutation where the first disabled link encountered is toggled back on.
    ...
    public boolean isCompatibleTo(Genotype network) {
    ...
    private int getNumDisjointLinks(Genotype network) {
        int numDisjoint;
    ...
    private double getAvgWeightDiff(Genotype network) {
